...
export default function ActivitiesSearch() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Không thể tìm kiếm hoạt động. Thử lại sau.', 'Lỗi tìm kiếm')
    } finally {
      setIsLoading(false)
    }
  }
          ...
          <div className="mt-8">
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-[#0F4C5C]">
                Found {results.length} activit{results.length !== 1 ? 'ies' : 'y'}
              </h4>
            </div>
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-[#A1A1AA]">avg. cost</p>
                        </div>
                      </div>
